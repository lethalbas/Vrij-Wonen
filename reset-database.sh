...
echo "   - 8 house objects with local images"
echo "   - 330+ Dutch cities"
echo "   - 15 properties"
echo "   - 5 staff users with role-based access:"
echo "     * api_admin (password) - Full API access"
echo "     * system_admin (password) - System administration"
echo "     * admin (password) - Administrative functions"
echo "     * medewerker (password) - Basic staff access"
echo "     * archived (password) - No access (deactivated)"
echo "   - 5 roles with priority system"
